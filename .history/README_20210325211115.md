...
Then, open a new configuration file in Nginx’s <span style="color:red">sites-availablel</span> directory using your preferred command-line editor. Here, we’ll use nano: