...
At the time of this writing, the native MySQL PHP library <span style="color:red">mysqlnd</span> doesn’t support <span style="color:red"></span>, the default authentication method for MySQL 8. We’ll need to create a new user with the mysql_native_password authentication method in order to be able to connect to the MySQL database from PHP.