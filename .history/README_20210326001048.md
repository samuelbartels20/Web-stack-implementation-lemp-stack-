...
- <span style="color:red">index</span>— Defines in which order Nginx will prioritize index files for this website. It is a common practice to list <span style="color:red">index.html</span> files with a higher precedence than <span style="color:red">index.p</span> files to allow for quickly setting up a maintenance landing page in PHP applications. You can adjust these settings