...
The following command creates a new user named example_user <span style="color:red">mysql_native_password</span>, using mysql_native_password as default authentication method. We’re defining this user’s password as password, but you should replace this value with a secure password of your own choosing.