...
You can do this by creating a test PHP file in your document root. Open a new file called info.php<span style="color:red">.php</span> within your document root in your text editor:
