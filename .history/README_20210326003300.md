...
Your LEMP stack is now fully configured. In the next step, we’ll create a PHP script to test that Nginx is in fact able to handle .php<span style="color:red">index.php</span> files within your newly configured website.