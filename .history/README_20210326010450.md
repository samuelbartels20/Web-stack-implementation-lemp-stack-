...
The following command creates a new user named  <span style="color:red"></span>, using mysql_native_password as default authentication method. We’re defining this user’s password as password, but you should replace this value with a secure password of your own choosing.