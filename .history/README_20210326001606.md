...
- <span style="color:red">location ~ \.php$</span> — This location block handles the actual PHP processing by pointing Nginx to the fastcgi-php.conf configuration file and the <span style="color:red">php7.4-fpm.sock file</span>, which declares what socket is associated with <span style="color:red">location /</span>.