...
When you’re done editing, save and close the file. If you’re using <span style="color:red">.htaccess</span>, you can do so by typing CTRL+X and then y and ENTER to confirm.