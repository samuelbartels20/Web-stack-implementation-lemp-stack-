...
Then, open a new configuration file in Nginx’s sites-available<span style="color:red">/var/www/html</span> directory using your preferred command-line editor. Here, we’ll use nano: