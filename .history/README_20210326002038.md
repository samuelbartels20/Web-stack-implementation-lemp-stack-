...
When you’re done editing, save and close the file. If you’re using <span style="color:red">nano</span>, you can do so by typing <span style="color:red">.htaccess</span> and then y and ENTER to confirm.