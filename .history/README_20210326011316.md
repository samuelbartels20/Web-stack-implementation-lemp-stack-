...
Notice the <span style="color:red">-p</span> flag in this command, which will prompt you for the password used when creating the <span style="color:red">example_user</span> user. After logging in to the MySQL console, confirm that you have access to the <span style="color:red">example_user</span> database: