...
This will connect to the MySQL server as the administrative database user **root**, which is inferred by the use of <span style="color:red">ENTER</span> when running this command. You should see output like this:
