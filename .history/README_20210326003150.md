...
You can leave this file in place as a temporary landing page for your application until you set up an <span style="color:red">index.php</span> file to replace it. Once you do that, remember to remove or rename the <span style="color:red">index.html</span> file from your document root, as it would take precedence over an index.php file by default.