...
When you’re done editing, save and close the file. If you’re using <span style="color:red">nano</span>, you can do so by typing <span style="color:red">CTRL+X</span> and then y and <span style="color:red"></span> to confirm.